    ...
    <div className={styles.regPage}>
      <div className={styles.container}>
        ...
        <div className={styles.validationPassword}>
          ...
          <p className={`${styles.helpLabel} ${hasLetter ? styles.valid : ""}`}>
          ...
          <p className={`${styles.helpLabel} ${hasDigitOrSpecial ? styles.valid : ""}`}>
            <div>
              <svg width="12" height="12" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="7" cy="7.18945" r="6" stroke="#A6A6A6" stroke-width="1.5"/>
              </svg>
          ...
          <p className={`${styles.helpLabel} ${hasMinLength ? styles.valid : ""}`}>
            <div>
              <svg width="12" height="12" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="7" cy="7.18945" r="6" stroke="#A6A6A6" stroke-width="1.5"/>
              </svg>
