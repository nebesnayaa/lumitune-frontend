...
import { addTrackToPlaylist, getAlbumById } from "../../api/contentService";
...
const TrackCards: React.FC<TrackCardsProps> = ({ playlistId, songs, format }) => {
    ...
    <div className={styles.trackList}>
      { songs.map((song, index)=> (
        <div className={styles.trackItem} key={index} onClick={()=> handleTrackClick(song)}>
          ...
          {format == "adding" && 
            <svg className={styles.addIcon} onClick={()=>handleAddTrackToPlaylist} width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
