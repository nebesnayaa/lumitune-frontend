			...
			<nav className={styles.menuSection}>
				...
				<div className={`${styles.menuItem} ${styles.myPlaylistsItem}`}>
					...
					<svg onClick={toggleDropdown} width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M4.75 1.84375H16M4.75 7H16M4.75 12.1562H16M1 1.84375H1.9375M1 7H1.9375M1 12.1562H1.9375" stroke="#86AECA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
					</svg>
					{showDropdown && (
